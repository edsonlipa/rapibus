          ...
          <nav class="navbar navbar-expand-lg navbar-light">
            ...
            <div class="collapse navbar-collapse main-menu-item" id="navbarSupportedContent">
              <ul class="navbar-nav">
                ...
                <li class="nav-item">
                  <a class="nav-link active_color" href="contact.html">Contact</a>
                </li>
              </ul>
            </div>
  ...
  <section class="contact-section blog_padding">
    <div class="container">
        <div class="d-none d-sm-block mb-5 pb-4">
            <iframe id="App" class="w-100 p-3" src="https://muniarequipa.gob.pe/oficina-virtual/infracciones/rutas.html"  height="600" scrolling="no" frameBorder="0">Browser not compatible.</iframe>
            <script>
                jQuery(jQuery('[id="App"]')[0].contentWindow.document.body).on('click', '*', function() {
